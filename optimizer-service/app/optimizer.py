...
def optimize_roster(starters, available_players, money):
    ...
    for player in available_players:
        ...
        costs.append(max(1, math.floor(player.core.target_price + (player.core.target_price * PRICE_OFFSET))))
        tier = 3
        stud = "NOPE"
    ...
    tier_2_wrs = 1
    studs = 1
    roster_size = TEAM_SIZE - BENCH_SIZE
...
def optimize_bench(bench, available_players, money):
    ...
    ks = 0
    ds = 0
    bench_size = BENCH_SIZE - len(bench)
